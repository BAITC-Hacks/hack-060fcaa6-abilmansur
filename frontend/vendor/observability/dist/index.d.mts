...
interface Observability {
   ...
   * remover.
   */
  listen(level: ObservabilityLevel | ObservabilityLevel[], handler: (event: ObservabilityEvent) => void): Remove;
...
declare function toErrorInfo(value: unknown): ObservabilityErrorInfo;
//#endregion
export { type Observability, type ObservabilityDetail, type ObservabilityErrorInfo, type ObservabilityEvent, type ObservabilityLevel, type Remove, observability, toErrorInfo };
