...
const require_Calendar = require("./Calendar-CqbAPz6j.cjs");
...
const FloatingDatePicker = (0, react.forwardRef)((_, ref) => {
	...
	const menuPositionDivRefs = require_useMultipleRefs.useMultipleRefs(setReference, menuPositionDivRef);
	const floatingRef = require_useMultipleRefs.useMultipleRefs(setFloating, ref);
...
//# sourceMappingURL=DatePicker-BEdZZMXw.cjs.map