...
export const useScrollToBottom = ({ ref, lastMessage, scrollVariant, userMessageSelector = ".inv-shell-thread-message-user", isRunning, isLoadingMessages, scrollOnLoad = true, }) => {
