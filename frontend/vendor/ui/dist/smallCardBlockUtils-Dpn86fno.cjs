...
function useCarouselMask() {
	...
	const [maskLeft, setMaskLeft] = (0, react.useState)(false);
	const [maskRight, setMaskRight] = (0, react.useState)(false);
	const updateMask = (0, react.useCallback)(() => {
		if (!element) return;
...
//#endregion
Object.defineProperty(exports, "getRowConfiguration", {
	enumerable: true,
	get: function() {
		return getRowConfiguration;
	}
});
Object.defineProperty(exports, "useCarouselMask", {
	enumerable: true,
	get: function() {
		return useCarouselMask;
	}
});

//# sourceMappingURL=smallCardBlockUtils-Dpn86fno.cjs.map