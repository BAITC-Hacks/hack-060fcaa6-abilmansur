...
import { DatePicker as InvDatePicker } from "../../components/DatePicker";
...
export const DatePicker = defineComponent({
    ...
    component: ({ props }) => {
        ...
        if (mode === "range") {
            return (_jsx(InvDatePicker, { mode: "range", selectedRangeDates: field.value, setSelectedRangeDates: handleChange }));
        }
        return (_jsx(InvDatePicker, { mode: "single", selectedSingleDate: field.value, setSelectedSingleDate: handleChange }));
    },
});
