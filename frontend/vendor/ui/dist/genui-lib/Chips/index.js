...
import { Chips as InvChips } from "../../components/Chips";
...
import { ChipsSchema } from "./schema";
export * from "./schema";
function ChipsRenderer({ props, renderNode }) {
    ...
    return (_jsx(InvChips, { type: type, selected: selection, disabled: isStreaming, onToggle: handleToggle, items: items.map((item) => ({
