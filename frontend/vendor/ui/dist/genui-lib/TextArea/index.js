...
import { TextArea as InvTextArea } from "../../components/TextArea";
...
export const TextArea = defineComponent({
    ...
    component: ({ props }) => {
        ...
        return (_jsx(InvTextArea, { name: field.name, placeholder: props.placeholder || "", rows: props.rows || 3, value: field.value ?? "", onFocus: () => formValidation?.clearFieldError(field.name), onChange: (e) => {
