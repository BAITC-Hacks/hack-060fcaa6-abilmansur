"use client";
import { createLibrary } from "@inv/lang";
...
// ── Component Groups ──
export const invComponentGroups = [
    {
        name: "Layout",
        components: [
            "Stack",
...
export { invAdditionalRules, invExamples, invPromptOptions } from "./prompt-options";
// ── Library ──
export const invLibrary = createLibrary({
    root: "Stack",
...
//# sourceMappingURL=invLibrary.js.map