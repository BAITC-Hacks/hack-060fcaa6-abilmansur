...
import { BoldTextSchema } from "./schema";
export * from "./schema";
function BoldTextRenderer({ props }) {
    const blockVariant = props.subtext
        ...
        : props.variant === "number"
            ? "highlight-number"
            : "highlight-text";
    return (_jsx(TextBlockView, { variant: blockVariant, primary: props.value, secondary: props.subtext, type: props.variant, size: props.size, align: "left", secondaryTone: getMetricSubtextTone(props.subtextVariant, props.subtext) }));
}
