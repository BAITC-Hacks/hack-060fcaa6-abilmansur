...
export declare const SectionItem: import("@inv/lang").DefinedComponent<z.ZodObject<{
    value: z.ZodString;
    trigger: z.ZodString;
    content: z.ZodArray<z.ZodUnion<readonly [z.core.$ZodType<import("@inv/lang-core").SubComponentOf<{
        text: string;
