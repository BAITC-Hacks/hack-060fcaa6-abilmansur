...
export declare const TabItem: import("@inv/lang").DefinedComponent<z.ZodObject<{
    value: z.ZodString;
    trigger: z.ZodString;
...
export declare const TabsRenderer: ({ props, renderNode }: TabsRenderProps) => React.JSX.Element | null;
export declare const Tabs: import("@inv/lang").DefinedComponent<z.ZodObject<{
