...
import { CheckBoxGroup as InvCheckBoxGroup } from "../../components/CheckBoxGroup";
import { CheckBoxItem as InvCheckBoxItem } from "../../components/CheckBoxItem";
...
export const CheckBoxGroup = defineComponent({
    ...
    component: ({ props }) => {
        ...
        return (_jsx(InvCheckBoxGroup, { children: items.map((item, i) => (_jsx(InvCheckBoxItem, { name: item.props.name, label: item.props.label, description: item.props.description || "", checked: aggregate[item.props.name] ?? item.props.defaultChecked ?? false, onChange: (val) => {
