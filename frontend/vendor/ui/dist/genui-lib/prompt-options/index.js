// Server-safe prompt data for the Inv component library.
// ── Examples ──
export const invExamples = [
...
export const invAdditionalRules = [
...
export const invPromptOptions = {
    examples: invExamples,
    additionalRules: invAdditionalRules,
};
// Inv Chat Library
export const invChatExamples = [
...
export const invChatAdditionalRules = [
    "When asked about data, generate realistic/plausible data",
...
export const invChatPromptOptions = {
