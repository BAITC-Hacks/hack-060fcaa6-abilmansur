...
export declare const CarouselRenderer: ({ props, renderNode }: CarouselRenderProps) => import("react").JSX.Element;
export declare const Carousel: import("@inv/lang").DefinedComponent<z.ZodObject<{
    children: z.ZodArray<z.ZodArray<z.ZodUnion<readonly [z.core.$ZodType<import("@inv/lang-core").SubComponentOf<{
        text: string;
