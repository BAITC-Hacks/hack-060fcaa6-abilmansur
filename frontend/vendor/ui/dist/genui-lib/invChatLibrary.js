...
import { createLibrary, defineComponent } from "@inv/lang";
...
const ChatCard = defineComponent({
    ...
    component: ({ props, renderNode }) => (_jsx(CardSourceProvider, { sources: props.sources, children: _jsxs(InvCard, { width: "full", style: {
                display: "flex",
                flexDirection: "column",
                gap: "var(--inv-space-m)",
            }, children: [renderNode(props.children), _jsx(Sources, {})] }) })),
});
// ── Component Groups ──
export const invChatComponentGroups = [
    {
        name: "Content",
        components: [
            "CardHeader",
...
// ── Examples ──
export { invChatAdditionalRules, invChatExamples, invChatPromptOptions, } from "./prompt-options/index";
// ── Library ──
export const invChatLibrary = createLibrary({
    root: "Card",
...
//# sourceMappingURL=invChatLibrary.js.map