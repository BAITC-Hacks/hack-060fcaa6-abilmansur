...
import { defineComponent, parseStructuredRules, useFormName, useFormValidation, useGetFieldValue, useIsStreaming, useSetFieldValue, } from "@inv/lang";
import React from "react";
import { OptionCards as InvOptionCards } from "../../components/OptionCards";
...
import { OptionCardsSchema } from "./schema";
export * from "./schema";
...
function OptionCardsRenderer({ props, renderNode }) {
    ...
    const handleToggle = (itemValue) => {
        ...
        const validationValue = type === "single"
    ...
    return (_jsx(InvOptionCards, { type: type, selected: selection, disabled: isStreaming, onToggle: handleToggle, items: items.map((item) => {
