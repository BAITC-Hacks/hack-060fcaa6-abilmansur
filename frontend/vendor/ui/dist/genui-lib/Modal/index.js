...
import { Modal as InvModal } from "../../components/Modal";
...
export const Modal = defineComponent({
    ...
    component: ({ props, renderNode }) => {
        ...
        return (_jsx(InvModal, { title: props.title, open: isOpen, onOpenChange: handleOpenChange, size: props.size ?? "md", children: renderNode(props.children) }));
    },
});
