 ...
 * @category Components
 */
export declare const ShareThread: {
    ({ generateShareLink, modalTitle, customTrigger }: ShareThreadProps): React.JSX.Element | null;
    displayName: string;
};
//# sourceMappingURL=ShareThread.d.ts.map