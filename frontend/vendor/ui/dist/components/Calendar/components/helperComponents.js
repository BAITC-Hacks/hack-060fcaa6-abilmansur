...
export const MonthsDropdown = (props) => {
    ...
    return (_jsxs(Select, { onValueChange: (value) => onChange?.({
        ...
        }), value: getMonthName(Number(value)), disabled: disabled, "aria-label": ariaLabel, children: [_jsx(SelectTrigger, { className: clsx("inv-calendar-select-trigger", className), children: _jsx(SelectValue, { placeholder: "Select a month" }) }), _jsx(SelectContent, { container: container, className: "inv-calendar-select-content-months", sideOffset: 4, alignOffset: 0, style: {
...
export const YearsDropdown = (props) => {
    ...
    return (_jsxs(Select, { onValueChange: (value) => onChange?.({
        ...
        }), value: String(value), disabled: disabled, "aria-label": ariaLabel, children: [_jsx(SelectTrigger, { className: clsx("inv-calendar-select-trigger", className), children: _jsx(SelectValue, { placeholder: "Select a month" }) }), _jsx(SelectContent, { container: container, className: "inv-calendar-select-content-years", viewportClassName: clsx("inv-calendar-select-viewport", botType === "mobile" && "inv-calendar-select-viewport-mobile"), sideOffset: 4, alignOffset: -75, style: {
                    minHeight: `${containerHeight - 45}px`,
                    maxHeight: `${containerHeight - 45}px`,
                }, children: options?.map((option) => (_jsx(SelectItem, { value: String(option.value), disabled: option.disabled, showTick: false, className: "inv-calendar-select-item", children: option.label }, option.value))) })] }, key));
};
