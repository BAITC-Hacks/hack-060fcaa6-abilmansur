...
export const SingleStackedBar = ({ data, categoryKey, dataKey, theme = "ocean", customPalette, legend = true, legendVariant = "default", className, style, animated = true, }) => {
    ...
    return (_jsxs("div", { ref: wrapperRef, className: clsx("inv-single-stacked-bar-chart-container", className, {
            "inv-single-stacked-bar-chart-container-gap": legend && legendVariant === "default",
        }), style: style, "data-inv-chart": exportData, children: [_jsx("div", { className: "inv-single-stacked-bar-chart", children: segments.map((segment, index) => {
                    const isActive = activeIndex === null || activeIndex === index;
                    return (_jsx("div", { className: clsx("inv-single-stacked-bar-chart-segment", {
                            "inv-single-stacked-bar-chart-animated": animated,
                        }), style: {
