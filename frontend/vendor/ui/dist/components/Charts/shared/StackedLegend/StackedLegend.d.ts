...
export declare const StackedLegend: ({ items, onItemHover, activeKey, onLegendItemHover, containerWidth, separator, showTitle, layout, className, style, }: StackedLegendProps) => React.JSX.Element;
export {};
//# sourceMappingURL=StackedLegend.d.ts.map