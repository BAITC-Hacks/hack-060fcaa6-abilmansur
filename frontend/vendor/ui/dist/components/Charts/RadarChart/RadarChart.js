...
const RadarChartComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant = "line", grid = true, legend = true, strokeWidth = 2, areaOpacity = 0.2, icons = {}, isAnimationActive = false, height, width, }) => {
    ...
    const wrapperClassName = useMemo(() => clsx("inv-radar-chart-container-wrapper", {
        "layout-column": true,
    }), []);
    ...
    return (_jsx(SideBarTooltipProvider, { isSideBarTooltipOpen: false, setIsSideBarTooltipOpen: () => { }, data: undefined, setData: () => { }, children: _jsxs("div", { ref: wrapperRef, className: wrapperClassName, style: wrapperStyle, "data-inv-chart": exportData, children: [_jsx("div", { className: "inv-radar-chart-container", children: _jsx("div", { className: "inv-radar-chart-container-inner", children: _jsx("div", { style: chartSizeStyle, children: _jsx(ChartContainer, { config: chartConfig, className: "inv-radar-chart", rechartsProps: rechartsProps, children: _jsxs(RechartsRadarChart, { data: data, margin: {
                                        left: 10,
                                        right: 10,
                                        top: 10,
                                        bottom: 10,
                                    }, children: [grid && _jsx(PolarGrid, { className: "inv-chart-polar-grid", stroke: "currentColor" }), _jsx(PolarAngleAxis, { dataKey: categoryKey, tick: _jsx(AxisLabel, { portalContainerRef: wrapperRef }) }), _jsx(ChartTooltip, { cursor: false, content: _jsx(CustomTooltipContent, { parentRef: wrapperRef }) }), radars] }) }) }) }) }), legend && (_jsx(DefaultLegend, { items: legendItems, containerWidth: wrapperRect.width, isExpanded: isLegendExpanded, setIsExpanded: setIsLegendExpanded, style: { paddingTop: 0 } }))] }) }));
};
