...
const require_components_Separator_index = require("../Separator/index.cjs");
...
tiny_invariant = require_chunk.__toESM(tiny_invariant, 1);
...
const useCanvasContextForLabelSize = () => {
	const { theme: userTheme } = require_ThemeProvider.useTheme();
	return (0, react.useMemo)(() => {
...
const DefaultLegend = (0, react.memo)(react.default.forwardRef(({ items, className, yAxisLabel, xAxisLabel, containerWidth, isExpanded, setIsExpanded, style }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [(xAxisLabel || yAxisLabel) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			}, item.key)), showToggleButton && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_Button_index.Button, {
				variant: "tertiary",
				size: "small",
				ref: buttonRef,
		...
		children: [
			shouldShowScrollControls && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [showTitle && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: shouldShowScrollControls && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_IconButton_index.IconButton, {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				}), index !== itemsToDisplay.length - 1 && separator && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_Separator_index.Separator, { className: "inv-stacked-legend-separator" })] }, item.key))
			}),
			isShowMoreLayout && !showAll && items.length > LEGEND_ITEM_LIMIT && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_Button_index.Button, {
				variant: "secondary",
				size: "small",
...
const BarChartComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant = "grouped", tickVariant = "multiLine", grid = true, icons = {}, radius, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height, width }) => {
	...
	const { mode, theme: userTheme } = require_ThemeProvider.useTheme();
...
const SingleStackedBar = ({ data, categoryKey, dataKey, theme = "ocean", customPalette, legend = true, legendVariant = "default", className, style, animated = true }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			legend && legendVariant === "default" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_Separator_index.Separator, {}),
