...
export declare const CustomBarShape: React.MemoExoticComponent<(props: CustomBarShapeProps) => React.JSX.Element | null>;
export {};
//# sourceMappingURL=CustomBarShape.d.ts.map