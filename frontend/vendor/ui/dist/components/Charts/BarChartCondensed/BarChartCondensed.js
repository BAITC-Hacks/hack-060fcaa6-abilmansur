...
const BarChartCondensedComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant = "grouped", tickVariant = "singleLine", grid = true, icons = {}, radius, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height = CHART_HEIGHT, width, maxBarWidth = DEFAULT_MAX_BAR_WIDTH, }) => {
    ...
    const yAxis = useMemo(() => {
        ...
        return (_jsx("div", { className: "inv-bar-chart-condensed-y-axis-container", children: _jsxs(RechartsBarChart, { width: yAxisWidth, height: effectiveHeight, data: data, stackOffset: "sign", margin: {
                    top: chartMargin.top,
    ...
    return (_jsx(LabelTooltipProvider, { children: _jsx(SideBarTooltipProvider, { isSideBarTooltipOpen: isSideBarTooltipOpen, setIsSideBarTooltipOpen: setIsSideBarTooltipOpen, data: sideBarTooltipData, setData: setSideBarTooltipData, children: _jsxs("div", { className: clsx("inv-bar-chart-condensed-container", className), "data-inv-chart": exportData, style: {
                    width: width ? `${width}px` : undefined,
                }, children: [yAxisLabel && (_jsx("div", { className: "inv-bar-chart-condensed-y-axis-label", children: yAxisLabel })), _jsxs("div", { className: "inv-bar-chart-condensed-container-inner", ref: containerRef, children: [yAxis, _jsx("div", { className: "inv-bar-chart-condensed", ref: chartContainerRef, children: _jsx(ChartContainer, { config: chartConfig, style: {
