...
const LineChartCondensedComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant: lineChartVariant = "natural", tickVariant = "singleLine", grid = true, icons = {}, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height = CHART_HEIGHT, width, strokeWidth = 2, }) => {
    ...
    const yAxis = useMemo(() => {
        ...
        return (_jsx("div", { className: "inv-line-chart-condensed-y-axis-container", children: _jsxs(RechartsLineChart, { width: yAxisWidth, height: effectiveHeight, data: data, margin: {
                    top: chartMargin.top,
    ...
    return (_jsx(LabelTooltipProvider, { children: _jsx(SideBarTooltipProvider, { isSideBarTooltipOpen: isSideBarTooltipOpen, setIsSideBarTooltipOpen: setIsSideBarTooltipOpen, data: sideBarTooltipData, setData: setSideBarTooltipData, children: _jsxs("div", { className: clsx("inv-line-chart-condensed-container", className), "data-inv-chart": exportData, style: {
                    width: width ? `${width}px` : undefined,
                }, children: [yAxisLabel && (_jsx("div", { className: "inv-line-chart-condensed-y-axis-label", children: yAxisLabel })), _jsxs("div", { className: "inv-line-chart-condensed-container-inner", ref: containerRef, children: [yAxis, _jsx("div", { className: "inv-line-chart-condensed", ref: chartContainerRef, children: _jsx(ChartContainer, { config: chartConfig, style: { width: "100%", height: effectiveHeight }, rechartsProps: {
                                        width: "100%",
                                        height: "100%",
