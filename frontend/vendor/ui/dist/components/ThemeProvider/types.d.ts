 ...
 */
export declare const CHART_PALETTE_KEYS: readonly ["defaultChartPalette", "barChartPalette", "lineChartPalette", "areaChartPalette", "pieChartPalette", "radarChartPalette", "radialChartPalette", "horizontalBarChartPalette"];
export type ChartPaletteKey = (typeof CHART_PALETTE_KEYS)[number];
export type ChartColorPalette = {
    [K in ChartPaletteKey]?: string[];
};
/**
