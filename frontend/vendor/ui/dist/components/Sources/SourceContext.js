...
export const openSourceInNewTab = (url) => {
    safeOpenUrl(url);
};
/**
 ...
 */
export const CardSourceContext = createContext(undefined);
/**
 ...
 */
export const CardSourceProvider = ({ sources, children, }) => {
    ...
    return (_jsx(CardSourceContext.Provider, { value: enrichedSources, children: children }));
};
/**
 ...
 */
export const useCardSourceContext = () => {
