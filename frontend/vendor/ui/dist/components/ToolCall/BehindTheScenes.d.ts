...
export declare const BehindTheScenes: ({ isStreaming, toolCallsComplete, children, }: BehindTheScenesProps) => import("react").JSX.Element;
//# sourceMappingURL=BehindTheScenes.d.ts.map