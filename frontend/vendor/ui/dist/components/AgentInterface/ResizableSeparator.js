 ...
 */
export const ResizableSeparator = ({ onResize, onResizeStep, onDragStart, onDragEnd, getAriaValues, controlsId, ariaLabel = "Resize panel", className, }) => {
    ...
    return (_jsx("div", { role: "separator", "aria-orientation": "vertical", "aria-label": ariaLabel, "aria-controls": controlsId, "aria-valuenow": aria?.now, "aria-valuemin": aria?.min, "aria-valuemax": aria?.max, "aria-valuetext": aria ? `${aria.now}%` : undefined, tabIndex: 0, className: clsx("inv-agent-resizable-separator", className), onMouseDown: handleMouseDown, onKeyDown: handleKeyDown, onFocus: syncAria, children: _jsx("div", { className: "inv-agent-resizable-separator__handle" }) }));
};
